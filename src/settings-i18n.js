...
(function initSettingsI18n(root) {
  const STRINGS = {
    en: {
      ...
      shortcutsSubtitle: "Set a global shortcut for showing or hiding Clawd. Leave it empty to unbind.",
      ...
      rowSoundDesc: "Play a sound when Clawd reacts or celebrates.",
      ...
      aboutSubtitle: "A standalone pixel pet for your desktop.",
      aboutTagline: "Clawd hangs out on your screen and comes alive on its own.",
    ...
    zh: {
      ...
      sidebarAbout: "关于",
      shortcutsTitle: "快捷键",
      shortcutsSubtitle: "为显示或隐藏 Clawd 设置全局快捷键。留空即可解绑。",
      ...
      rowSound: "音效",
      rowSoundDesc: "Clawd 做出反应或庆祝时播放提示音。",
      rowOpenAtLogin: "开机自启",
      ...
      aboutTitle: "关于 Clawd",
      aboutSubtitle: "一只独立运行的像素桌宠。",
      aboutTagline: "Clawd 会待在你的屏幕上，自然地自己动起来。",
    ...
    ko: {
      ...
      sidebarAbout: "정보",
      shortcutsTitle: "단축키",
      shortcutsSubtitle: "Clawd 표시를 켜고 끄는 전역 단축키를 설정합니다. 비워 두면 해제됩니다.",
      ...
      rowSound: "효과음",
      rowSoundDesc: "Clawd가 반응하거나 기뻐할 때 효과음을 재생합니다.",
      ...
      aboutTitle: "Clawd 정보",
      aboutSubtitle: "데스크톱에서 혼자 살아가는 픽셀 펫.",
      aboutTagline: "Clawd가 화면 위에서 스스로 움직이며 함께합니다.",
